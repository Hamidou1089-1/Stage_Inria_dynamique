...
ax1.plot_surface(xx, zz, yy, color='red', alpha=0.3)
...
fig1.colorbar(surf, shrink=0.3, aspect=5)

# Enregistrement de la figure
plt.savefig('fig1_3d_bank_shock_default.png', dpi=500, bbox_inches='tight')
plt.close(fig1)
