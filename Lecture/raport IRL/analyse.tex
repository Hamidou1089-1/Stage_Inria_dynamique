...
1. Le risque idiosyncratique (ou spécifique) : propre à chaque institution, il bénéficie effectivement de la diversification par l'interconnexion. Face à ce type de risque, un réseau plus dense permet à chaque banque de répartir ses expositions, réduisant ainsi sa vulnérabilité aux défaillances isolées.

2. Le risque systémique (ou global) : affectant simultanément plusieurs parties du système, il peut au contraire être amplifié par l'interconnexion. Dans ce cas, les liens entre institutions deviennent des canaux de contagion plutôt que des mécanismes de dilution.
